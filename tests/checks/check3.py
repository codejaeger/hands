...
def process_tf_dataset(ds_raw, dataset):
    if dataset=="youtube":
        ...
        ds_processed = ds_raw.map(lambda image_path, mano, proj_mat : process_ds(freihand_projection)(image_path, mano, proj_mat), num_parallel_calls=2)
...
V_pred_778x2 = model(example[0])[1]
